<?php
if (session_status() === PHP_SESSION_NONE) { session_name('SMARTOPS_DEMO_SESSION'); session_start(); }
...
function smartops_sync_pending_ai_cases(bool $force = false): array {
    if (defined('SMARTOPS_DEMO_RUNTIME') && SMARTOPS_DEMO_RUNTIME) return ['success' => true, 'skipped' => true, 'reason' => 'isolated_demo'];
